...
git clone https://github.com/ros-controls/control_toolbox.git -b 1.18.2
...
git clone https://github.com/ros-perception/image_transport_plugins.git -b 1.15.0
...
git clone https://github.com/ros-perception/laser_filters.git -b 1.9.1
...
git clone https://github.com/ros-perception/perception_pcl.git -b 1.7.5
...
git clone https://github.com/ros-visualization/qwt_dependency.git -b 1.1.2
...
git clone https://github.com/ros/ros_comm.git -b 1.17.0
...
git clone https://github.com/ros-visualization/rqt_shell.git -b 0.4.12
...
git clone https://github.com/ros-visualization/rviz.git -b 1.14.25
...
git clone https://github.com/ros/xacro.git -b 1.14.18
git clone https://github.com/eric-wieser/ros_numpy.git -b 0.0.5
git clone https://github.com/ros-teleop/twist_mux.git -b 3.1.3
git clone https://github.com/ros-visualization/interactive_marker_twist_server.git -b 1.2.2
git clone https://github.com/ros-drivers/four_wheel_steering_msgs.git -b 1.1.1
git clone https://github.com/ros-controls/urdf_geometry_parser.git -b 0.1.0
git clone https://github.com/ros-controls/ros_controllers.git -b 0.22.0
git clone https://github.com/ros-planning/navigation.git -b 1.17.3
git clone https://github.com/ros-drivers/velodyne.git -b 1.7.0
#git clone https://github.com/ros-simulation/gazebo_ros_pkgs.git -b 2.9.2
#git clone https://github.com/rtv/Stage.git -b v4.3.0
